...
%%%%%%%%%%%%%%%%%%%%%%%%%
%
An autoregressive model of order $p$, denoted $AR(p)$, is defined by the equation
%
\begin{align}
X_t = c + \sum^p_{i=1} \phi_i X_{t-i} + \varepsilon_t,
\end{align}
%
where $\phi_1, \dots, \phi_p$ are the parameters of the model, $c$ is a constant, and $\varepsilon_t$ is white noise.
